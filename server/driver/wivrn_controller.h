...
public:
	...
	xrt_hand_joint_set get_hand_tracking(xrt_input_name name, uint64_t desired_timestamp_ns);
	...
	std::tuple<XrTime, XrDuration, XrDuration> tracking_stats(to_headset::input_pacing_control::target);
